...
5. Avvia Node-RED dal prompt dei comandi partendo dalla root `C:\`:
   ...
   node-red
   ```
6. Apri l'editor di Node-RED nel browser:
   - http://localhost:1880
...
8. Importa il flow del progetto:
   - Menu -> Import
   - seleziona [progetto_esame/docs/node_red_flow.json](c:\Users\franc\GitHub\Repositories\Sistemi_Operativi_Mobili\progetto_esame\docs\node_red_flow.json)
9. Fai `Deploy`.
10. Apri la dashboard nel browser:
...
- Porta: `1883`
- Telemetry topic: `sistemi_operativi_mobili/progetto_esame/telemetry`
- Status topic: `sistemi_operativi_mobili/progetto_esame/status`
