...
#define TELEMETRY_TOPIC "sistemi_operativi_mobili/environment_monitor/telemetry" /**< Topic used to publish sensor telemetry. */
#define STATUS_TOPIC "sistemi_operativi_mobili/environment_monitor/status" /**< Topic used to publish connection status messages. */
